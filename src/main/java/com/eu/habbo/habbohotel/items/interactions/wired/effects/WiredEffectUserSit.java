...
public class WiredEffectUserSit extends InteractionWiredEffect {
    public static final WiredEffectType type = WiredEffectType.RESET_TIMERS;

    protected String message = "";

    public WiredEffectUserSit(ResultSet set, Item baseItem) throws SQLException {
        super(set, baseItem);
    }

    public WiredEffectUserSit(int id, int userId, Item item, String extradata, int limitedStack, int limitedSells) {
